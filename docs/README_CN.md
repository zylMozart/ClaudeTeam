...
**把一个 CLAUDE.md 丢给 Claude Code，运行 `claude`，一支 AI 团队自动组建 —— 接入飞书、全员自治、零配置。**
...
- **一个文件启动** —— Clone 仓库、打开 Claude Code，跟着 CLAUDE.md 引导即可
...
就这么简单。Claude Code 自动读取 `CLAUDE.md`，引导你完成一切：
...
│
├── docs/                      # 文档
│   ├── SETUP_GUIDE.md         # 引导模板（用于生成 CLAUDE.md）
│   ├── POLICY.md              # 团队通讯规范
