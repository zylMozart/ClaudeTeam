"""Pure helpers for kanban daemon pid liveness / PID reuse checks."""
...
def is_expected_cmdline(cmdline: str | None, expected_fragment: str = "kanban_sync.py") -> bool:
...
def is_live_pid_probe(
    ...
    *,
    pid_alive: bool,
    cmdline: str | None,
    expected_fragment: str = "kanban_sync.py",
) -> bool:
