"""Shared PID liveness helpers for daemon processes.

Extracted from kanban_daemon.py and watchdog_daemon.py — identical logic,
only the expected_fragment default differed per daemon (now callers pass it
explicitly).
"""
...
def is_expected_cmdline(cmdline: str | None, expected_fragment: str) -> bool:
